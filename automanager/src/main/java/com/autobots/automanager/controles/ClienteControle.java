...
public class ClienteControle {
	...
	public ResponseEntity<Cliente> obterCliente(@PathVariable("idCliente") long idCliente) {
		Cliente cliente = repositorio.findById(idCliente).get();
		if (cliente == null) {
	...
	*/
	...
	public ResponseEntity<?> excluirCliente(@PathVariable("idCliente") long idCliente) {
